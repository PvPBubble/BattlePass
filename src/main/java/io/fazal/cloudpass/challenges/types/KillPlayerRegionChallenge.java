...
public class KillPlayerRegionChallenge extends Challenge implements Listener
{

    public KillPlayerRegionChallenge(final String name, final Tier tier, final int max, final String description, final String world, String region) {
